...
const Disclaimer = ({category}) => {
    return <div className={styles.menuGeneral}> 
                ...
                <Titulos texto='Política de ' span='h1'></Titulos><h1 className={styles.category}>{category}</h1>
                </div>
                <p>Blue Team Adopciones informa acerca del uso de las cookies en su página web: https://www.blueteamadopciones.com/</p>
                <Titulos texto='¿Qué son las cookies?' span='h3'></Titulos>
                ...
                <Titulos texto='Tipos de cookies' span='h3'></Titulos>
                ...
                <div className={styles.hardtext}>
                    <Titulos texto='• Cookies propias:' span='h7'></Titulos>
                    ...
                    <Titulos texto='• Cookies de terceros:' span='h7'></Titulos>
                    ...
                    <Titulos texto='• Cookies de sesión:' span='h7'></Titulos>
                    ...
                    <Titulos texto='• Cookies persistentes:' span='h7'></Titulos>
                    ...
                    <Titulos texto='• Cookies técnicas:' span='h7'></Titulos>
                    ...
                    <Titulos texto='• Cookies publicitarias:' span='h7'></Titulos>
                    <p>Permiten la gestión, de la forma más eficaz posible, de los espacios publicitarios.</p>
                    <Titulos texto='• Cookies de publicidad comportamental:' span='h7'></Titulos>
                    ...
                    <Titulos texto='• Cookies de redes sociales externas:' span='h7'></Titulos>
                ...
                <Titulos texto='Desactivación y eliminación de cookies' span='h3'></Titulos>
                <div className={styles.hardtext}>
                    ...
                    <Titulos texto='• Microsoft Internet Explorer o Microsoft Edge:' span='h7'></Titulos>
                    ...
                    <Titulos texto='• Mozilla Firefox:' span='h7'></Titulos>
                    ...
                    <Titulos texto='• Opera:' span='h7'></Titulos>
                    ...
                    <Titulos texto='• Ghostery:' span='h7'></Titulos>
                    <a href="www.ghostery.com/">www.ghostery.com/</a>
                    <Titulos texto='• Your Online Choices:' span='h7'></Titulos>
                ...
                <Titulos texto='A continuación se identifican las cookies que están siendo utilizadas en este portal así como su tipología y función:' span='h3'></Titulos>
                <div className={styles.hardtext}>
                    <Titulos texto='• _utma' span='h7'></Titulos>
                    ...
                    <Titulos texto='• _utmb' span='h7'></Titulos>
                    ...
                    <p>Tipo: Tercero</p>
                    <p>Finalidad: Analítica</p>
                    <Titulos texto='• _utmc' span='h7'></Titulos>
                    <p>Duración: Sesión</p>
                    <p>Descripción: Almacena información sobre la actividad de la visita a nuestro sitio web y principalmente la duración de ésta.</p>
                    <p>Tipo: Tercero</p>
                    <p>Finalidad: Analítica</p>
                    ...
                    <Titulos texto='• _utmz' span='h7'></Titulos>
                    ...
                    <p>Tipo: Tercero</p>
                    <p>Finalidad: Analítica</p>
                    <Titulos texto='• _ga' span='h7'></Titulos>
                    <p>Duración: 2 años</p>
                    ...
                    <p>Tipo: Tercero</p>
                    <p>Finalidad: Analítica</p>
                    <Titulos texto='• _gat' span='h7'></Titulos>
                    ...
                    <Titulos texto='• _gid' span='h7'></Titulos>
                    ...
                    <p>Tipo: Tercero</p>
                    <p>Finalidad: Publicidad comportamental</p>
                    <Titulos texto='• LOGIN_INFO' span='h7'></Titulos>
                    <p>Duración: 2 años</p>
                    ...
                    <p>Tipo: Tercero</p>
                    <p>Finalidad: Analítica</p>
                    <Titulos texto='• AMP_TOKEN' span='h7'></Titulos>
                ...
                <Titulos texto='Aceptación de la Política de cookies' span='h3'></Titulos>
                <div className={styles.hardtext}>
                ...
                <Titulos texto='Protección de datos de carácter personal según el RGPD' span='h3'></Titulos>
                <div className={styles.hardtext}>
                    ...
                    <br></br>
                    <Titulos texto='¿Con qué finalidad trataremos tus datos personales?' span='h7'></Titulos>
                    ...
                    <br></br>
                    <Titulos texto='¿Por cuánto tiempo se conservan los datos personales recabados?' span='h7'></Titulos>
                    ...
                    <br></br>
                    <Titulos texto='Legitimación:' span='h7'></Titulos>
                    ...
                    <br></br>
                    <Titulos texto='Destinatarios' span='h7'></Titulos>
                    ...
                    <br></br>
                    <Titulos texto='Retención de datos en conformidad a la LSSI' span='h7'></Titulos>
                    ...
                    <br></br>
                    <Titulos texto='Derechos propiedad intelectual ' span='h7'></Titulos>
                    ...
                    <br></br>
                    <Titulos texto='Propiedad intelectual del software' span='h7'></Titulos>
                    ...
                    <br></br>
                    <Titulos texto='Propiedad intelectual de los contenidos alojados' span='h7'></Titulos>
                    ...
                    <Titulos texto='Protección de la información alojada' span='h7'></Titulos>
                    ...
                    <br></br>
                    <Titulos texto='Comunicaciones comerciales' span='h7'></Titulos>
                ...
                {category == 'Legal' ? 
            <>
                <Titulos texto='Aviso Legal' span='h1'></Titulos>
                <div className={styles.hardtext}>
                    <p>En cumplimiento con el deber de información recogido en artículo 10 de la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y del Comercio Electrónico (LSSICE), el propietario de la web <a>https://www.adopcionesblueteam.com/</a>, le informa de lo siguiente:</p>
                    ...
                    <br></br>
                    <p>Los contenidos e información no vinculan a <a>https://www.adopcionesblueteam.com/</a> ni constituyen opiniones, consejos o asesoramiento legal de ningún tipo pues se trata meramente de un servicio ofrecido con carácter informativo y divulgativo.</p>
                    <br></br>
                    <p>Las páginas de Internet de <a>https://www.adopcionesblueteam.com/</a> pueden contener enlaces (links) a otras páginas de terceras partes que <a>https://www.adopcionesblueteam.com/</a> no puede controlar. Por lo tanto, <a>https://www.adopcionesblueteam.com/</a> no puede asumir responsabilidades por el contenido que pueda aparecer en páginas de terceros.</p>
                    <br></br>
                    <p>Los textos, imágenes, sonidos, animaciones, software y el resto de contenidos incluidos en este website son propiedad exclusiva de <a>https://www.adopcionesblueteam.com/</a> o sus licenciantes. Cualquier acto de transmisión, distribución, cesión, reproducción, almacenamiento o comunicación pública total o parcial, debe contar con el consentimiento expreso de <a>https://www.adopcionesblueteam.com/</a>.</p>
                    <br></br>
                    <p>Asimismo, para acceder a algunos de los servicios que <a>https://www.adopcionesblueteam.com/</a> ofrece a través del website deberá proporcionar algunos datos de carácter personal. En cumplimiento de lo establecido en el Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo, de 27 de abril de 2016, relativo a la protección de las personas físicas en lo que respecta al tratamiento de datos personales y a la libre circulación de estos datos le informamos que, mediante la cumplimentación de los presentes formularios, sus datos personales quedarán incorporados y serán tratados en los ficheros de Sociedad Protectora de Animales y Plantas de Malaga con el fin de poderle prestar y ofrecer nuestros servicios así como para informarle de las mejoras del sitio Web. Asimismo, le informamos de la posibilidad de que ejerza los derechos de acceso, rectificación, cancelación y oposición de sus datos de carácter personal, manera gratuita mediante email a lopd@adopcionesblueteam.com o en la dirección c/ Nyan Cat, 10 29640 - Malaga</p>
                    <Titulos texto='Donaciones puntuales' span='h2'></Titulos>
                    <p>Estamos acogidos al Régimen Fiscal especial de la Ley 49/2002, y por lo tanto su donación tiene derecho a deducciones fiscales.</p>
                    <br></br>
                    <p>Esta deducción se debe justificar con Certificado de Donación emitido por la Asociación.</p>
                    <br></br>
                    <p>Las tarifas cobradas por las diferentes plataformas de cobros no se consideran parte de la donación.</p>
                    <br></br>
                    <p>Para ello, aquellas personas que hubieran hecho una donación mediante transferencia u otra vía deberán contactar con socios@adopcionesblueteam.com para solicitarlo, indicando la fecha de la donación, cantidad, la vía de pago y nombre, apellidos y NIF para poder ser localizada la donación y emitir el Certificado.</p>
                    <br></br>
                    <p>Los Certificados se emiten hasta el día 31 de Diciembre del año de la donación, por lo que es muy importante solicitar el Certificado y aportar estos datos antes de esa fecha.</p>
                    <br></br>
                    <p>Una vez pasada esta fecha no será posible emitir Certificados de acuerdo a las normas de la Agencia Tributaria.</p>
                </div> 
            </> 
                : null}
