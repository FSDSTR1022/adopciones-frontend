                    ...
                    <div >
                        <div className={styles.petProfileBlocks}>
                            ...
                            <div className={styles.bigInfo}>
                                ...
                                <h4 key={userProfile.gender}><h5>Género</h5>: {userProfile.gender}</h4>
                                <h4 key={userProfile.idType}><h5>Tipo de documento</h5>: {userProfile.idType}</h4>
                                <h4 key={userProfile.idNumber}><h5>Número de documento</h5>: {userProfile.idNumber}</h4>
                                <h3 >Descripción</h3>
                                <h4 key={userProfile.description}>{userProfile.description}</h4>
                                <hr className={styles.divider}></hr>
